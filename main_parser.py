...
parser.add_argument('--pep_len', type=int, default=15)
...
parser.add_argument('--ndist', type=bool, default=True)
parser.add_argument('--block_type', type=str, default='bacd')
parser.add_argument('--res_layers',type=int, default=5)
parser.add_argument('--lstm_nhidden',type=int,default=256)
...
file1 = args.resnet_output_file
file2 = args.total_output_file
...
for test_set in range(5):
    ...
    for validation_set in range(5):
        ...
        net = ResidualNetwork(block_type=args.block_type, n_layers=8).to(device)
        ...
        for epoch in range(1, n_epoch):
            ...
            for X, y in tqdm(train_loader):
                ...
                loss = criterion(y.to(device).float(), mu, std, normal_dist=args.ndist)
        ...
        if args.lstm:
            ...
            if args.fucking_raw:
                ...
                net2 = Frozen_resnet(filters=args.lstm_nhidden).to(device)
